package com.qartf.popularmovies.adapters;
...
public class MoviesAdapter extends RecyclerView.Adapter<MoviesAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(com.qartf.popularmovies.R.layout.row_movie_item, parent, false);
        RelativeLayout relativeLayout = view.findViewById(com.qartf.popularmovies.R.id.gridView);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        @BindView(com.qartf.popularmovies.R.id.itemImage) ImageView poster;
        @BindView(com.qartf.popularmovies.R.id.movieTitle) TextView movieTitle;
        ...
        public void bind(int position) {
            ...
            Glide.with(poster.getContext())
                    .load(posterURL)
                    .thumbnail(Glide.with(poster.getContext()).load(com.qartf.popularmovies.R.drawable.ic_ondemand_video))
                    .into(poster);
